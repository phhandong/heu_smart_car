...
<body class="${kind}"><header class="site-head"><div class="head-inner"><a class="brand" href="/wiki/"><img src="/assets/club-logo.png" alt=""><span><strong>济海追风</strong><small>WIKI / 社团文档</small></span></a><nav aria-label="主导航"><a href="/wiki/"${kind === 'home' ? ' aria-current="page"' : ''}>Wiki 首页</a><a href="/">返回官网首页</a></nav></div></header>
${content}
<footer class="site-foot"><span>济海追风 · 哈尔滨工程大学</span><span>内容更新以页面日期为准</span><a href="/">返回官网首页</a></footer></body></html>`;
}
